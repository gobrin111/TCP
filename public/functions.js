...
function sendChat() {
    ...
    const browser_token = document.querySelector('input[name="xsrf+token"]').value;
    chatTextBox.value = "";
    if (ws) {
        // Using WebSockets
        ...
        const messageJSON = {"message": message, "browser_token": browser_token};
...
function chatMessageHTML(messageJSON) {
    ...
    const posterId = messageJSON.userId;
    const currentId = messageJSON.currentId;
    ...
    //     messageHTML = "<div id='message_" + messageId + "' style='background-color: " + color + "'><button onclick='deleteMessage(\"" + messageId + "\")'>X</button> ";
    // }
    messageHTML = "<div id='message_" + messageId + "' style='background-color: " + color + "'><button onclick='deleteMessage(\"" + messageId + "\")'>X</button> ";
